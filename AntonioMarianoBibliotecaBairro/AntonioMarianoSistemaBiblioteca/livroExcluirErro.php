...
<html lang="pt-br">
    <head>
        ...
        <title>Erro na exclusão do livro</title>
    </head>
    <body>
        <header>
            <nav>
        ...
        <main>
            <br>
            <h1 class="centralizar">Erro na exclusão do livro</h1>                
            <br>
            <p class="falhaLogin">Não foi possível excluir o livro selecionado, 
            porque esse livro foi retirado!</p>                                   
            <button class="botao bordaBotao margemBotao" onclick="livroListagem()">
                <a>Voltar</a> 
            </button>                       
        </main>
        <br>
