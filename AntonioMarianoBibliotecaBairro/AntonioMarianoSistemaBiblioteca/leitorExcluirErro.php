...
<html lang="pt-br">
    <head>
        ...
        <title>Erro na exclusão do leitor</title>
    </head>
    <body>
        <header>
            <nav>
        ...
        <main>
            <br>
            <h1 class="centralizar">Erro na exclusão do leitor</h1>                
            <br>
            <p class="falhaLogin">Não foi possível excluir o leitor selecionado, 
            porque possui no momento livro(s) consigo!</p>                                   
            <button class="botao bordaBotao margemBotao" onclick="leitorListagem()">
                <a>Voltar</a> 
            </button>                       
        </main>
        <br>
